...
The simple vue drag and drop component library.
...
```typescript
import { ref } from 'vue';
import { DndSource, MouseDnd, DndDropzone, useMouseDnd, push, remove } from '@vdnd/v3';
...
Registers global components: `NativeDnd`, `MouseDnd`, `TouchDnd`, `DndSource`, `DndDropzone` and `DndHandle`.
