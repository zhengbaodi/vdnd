...
vdnd supports the shallow reactive reading and writing for the following properties (instance.xxx = xxx) , but we should not update properties other than `options`.
