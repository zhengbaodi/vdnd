...
export function createDndContainer<
...
>() {
  return defineComponent({
    ...
    props: {
      ...
      model: {
        type: Object as PropType<DndModel<Source, Dropzone>>,
        required: true,
      },
    },
    setup(props, { slots }) {
...
> = ReturnType<typeof createDndContainer<S, D>>;

export const DndContainer = createDndContainer();
