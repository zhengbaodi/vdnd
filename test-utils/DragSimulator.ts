...
import { triggerEvent } from './dom.utils';
import {
  DRAG_DELAY,
...
export interface ElementWrapper<E extends Element = Element> {
  element: E;
...
export type DragEventTarget = HTMLElement | ElementWrapper<HTMLElement>;
...
export class NativeDragSimulator extends DragSimulator {
  static DRAG_EVENT_INTERVAL = BaseSimulatedDnd.eventTriggeringInterval.drag;
  static DRAG_OVER_EVENT_INTERVAL =
    BaseSimulatedDnd.eventTriggeringInterval.dragover;
